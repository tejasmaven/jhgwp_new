...
$order_args = match ($filter) {
	'popular' => ['orderby' => 'comment_count', 'order' => 'DESC'],
	'all'     => ['orderby' => 'date', 'order' => 'DESC'],
...
$newest_query = new WP_Query(array_merge($query_base, [
	'posts_per_page' => 4,
	'orderby'        => 'date',
	'order'          => 'DESC',
	'no_found_rows'  => true,
	...
	<div class="container">
		<header class="jhg-blog-hub-header">
			...
			<div class="jhg-blog-hub-filters body-xs">
				...
				<nav class="jhg-blog-hub-filters-nav" aria-label="<?php esc_attr_e('Blog filters', 'jhg-maven'); ?>">
					<a
						class="jhg-blog-hub-filter<?php echo 'newest' === $filter ? ' is-active' : ''; ?>"
						href="<?php echo $filter_link('newest'); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"
					><?php esc_html_e('Newest', 'jhg-maven'); ?></a>
					<a
		...
		<div class="row align-items-start jhg-blog-hub-body">
			<div class="col-12 col-lg-8 jhg-blog-hub-feed">
				<?php if ($has_newest_posts) : ?>
					<section class="jhg-blog-hub-block jhg-blog-hub-newest-section mb-4 mb-lg-5">
						<?php jhg_blog_dot_heading(__('Newest blogs', 'jhg-maven'), 'h3', 'jhg-blog-dot-heading jhg-blog-hub-block-heading'); ?>
				...
				<?php if ($all_query->have_posts()) : ?>
					<?php if ($has_newest_posts) : ?>
					<div class="jhg-blog-hub-feed-divider" aria-hidden="true">
						<span class="jhg-blog-hub-feed-divider-accent"></span>
					</div>
					<?php endif; ?>
